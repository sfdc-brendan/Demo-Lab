...
REPO_SUBPATH="subagents/ReleaseManager"
...
if [ "${1:-}" = "--cursor" ]; then
  ...
  echo "  curl -fsSL https://raw.githubusercontent.com/sfdc-brendan/Demo-Lab/main/subagents/ReleaseManager/install.sh | bash -s -- --both"
  echo ""
  exit 0
fi
