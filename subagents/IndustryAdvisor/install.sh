...
REPO_SUBPATH="subagents/IndustryAdvisor"
...
if [ "${1:-}" = "--cursor" ]; then
  ...
  echo "  curl -fsSL https://raw.githubusercontent.com/sfdc-brendan/Demo-Lab/main/subagents/IndustryAdvisor/install.sh | bash -s -- --both"
  echo ""
  exit 0
fi
