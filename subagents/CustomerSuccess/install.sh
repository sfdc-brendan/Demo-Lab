...
REPO_SUBPATH="subagents/CustomerSuccess"
...
if [ "${1:-}" = "--cursor" ]; then
  ...
  echo "  curl -fsSL https://raw.githubusercontent.com/sfdc-brendan/Demo-Lab/main/subagents/CustomerSuccess/install.sh | bash -s -- --both"
  echo ""
  exit 0
fi
